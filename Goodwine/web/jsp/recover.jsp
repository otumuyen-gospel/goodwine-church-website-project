            ...
            <div class="col-sm-12">
                <div class="col-md-push-4 col-md-4" id="login">
                    <div class="form-group">
                        <h2 class="form-text text-center"><span class="glyphicon glyphicon-lock"></span>Recover Account</h2>
                        <p class="form-text text-center">please use a stronger password this time</p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control input-lg" type="text" 
                                   name="email" disabled="true" value="<%=email%>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <button class="form-control btn btn-primary input-lg" id="recover" onclick="recover();">Change Password</button>
                    </div>

                    <div class="form-group">
                        <a class="form-control btn btn-link btn-lg" role="button" href="../page/account/">Login Now ?</a>
                    </div>
