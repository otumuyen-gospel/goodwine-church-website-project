                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" onclick="updateEmail();" 
                                        id="updateEmail">Update Email</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control input-lg" type="password" name="old">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-lock"></span></div>
                                    <input class="form-control input-lg" type="password" name="new">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-lock"></span></div>
                                    <input class="form-control input-lg" type="password" name="confirm">
                                </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" onclick="updatePassword();" 
