            ...
            <div class="col-md-9 mainbar">
                <div id="message-panel">
                    <div class="alert alert-success" role="alert">
                        ...
                        Home / Dashboard / Social Media Handles
                    </div>
                </div>
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-youtube"></span></div>
                                    <input class="form-control input-lg" type="url" placeholder="url" name="youtube">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-facebook"></span></div>
                                    <input class="form-control input-lg" type="url" placeholder="url" name="facebook">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-instagram"></span></div>
                                    <input class="form-control input-lg" type="url" placeholder="url" name="instagram">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-twitter"></span></div>
                                    <input class="form-control input-lg" type="url" placeholder="url" name="twitter">
                                </div>
                            </div>
                             <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="fa fa-envelope"></span></div>
                                    <input class="form-control input-lg" type="url" placeholder="url" name="email">
                                </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" id="socials" onclick="socials();">Save</button>
                            </div>
                        </div>
                    </div>
