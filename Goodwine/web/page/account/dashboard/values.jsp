            ...
            <div class="col-md-9 mainbar">
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Values" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">Enter Core Values</label>
                            ...
                            <div class="form-group">
                                    <input type="button" class="btn btn-primary btn-lg" id="updateValues" onclick="values();" value="Update Statement">
                            </div>
                        </form>
                    </div>
