...
<html  lang="en">
    <head>
        <title>account - leadership</title>
        <meta charset="utf-8">
            ...
            <div class="col-md-9 mainbar">
                <div id="message-panel">
                    <div class="alert alert-success" role="alert">
                        ...
                        Home / Dashboard / Church Leadership
                    </div>
                </div>
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form1" action="<%=request.getContextPath()%>/Overseer" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">General Overseer</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon">Select Photo</div>
                                    <input type="file" class="form-control" name="image"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Calling / Vision / Achievements</label>
                            ...
                            <div class="form-group">
                                  <input type="button" class="btn btn-primary btn-lg" id="overseer" onclick="overseers();" value="Save Update" />
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form2" action="<%=request.getContextPath()%>/Deputy" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">General Overseer Deputy</label>
                                <div class="input-group">
                                    <div class="input-group-addon">Name</div>
                                    <input type="text" class="form-control" name="name"/>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="form-label">Calling / Vision / Achievements</label>
                                <div class="form-inline">
                                    <textarea id="editor2" name="editor2" rows="10" data-sample-short></textarea>
                                    <script>
                            ...
                            <div class="form-group">
                                <input type="button" class="btn btn-primary btn-lg" id="deputy" onclick="deputys();" value="Save Update" />
                            </div>
                        </form>
                    </div>
