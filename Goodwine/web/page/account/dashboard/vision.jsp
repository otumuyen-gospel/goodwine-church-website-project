            ...
            <div class="col-md-9 mainbar">
                <div id="message-panel">
                    <div class="alert alert-success" role="alert">
                        ...
                        Home / Dashboard / Vision statement
                    </div>
                </div>
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Vision" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">Enter Vision statement</label>
                            ...
                            <div class="form-group">
                                        <input type="button" class="btn btn-primary btn-lg" id="updateVision" onclick="vision();" value="Update Statement">
                            </div>
                        </form>
                    </div>
