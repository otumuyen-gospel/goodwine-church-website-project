            ...
            <div class="col-md-9 mainbar">
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Sermon" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">Sermon Topic</label>
                                <input type="text" class="form-control" placeholder="sermon topic" name="topic"/>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Author</label>
                                <input type="text" class="form-control" placeholder="preacher" name="author"/>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Image For this Sermon</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="form-inline">
                                    <label class="checkbox">
                                        <input type="checkbox" value="" name="newsletter" checked> Send Newsletter
                                    </label>  
                                </div>
                                                                 
                            </div>
                            <div class="form-group">
                                <label class="form-label">Full Sermon</label>
                                <div class="form-inline">
                            ...
                            <div class="form-group">
                                <input type="button" class="btn btn-primary btn-lg" id="update" onclick="sermons();" value="save post"/>
                            </div>
                        </form>
                    </div>
