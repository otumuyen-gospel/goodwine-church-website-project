...
<html  lang="en">
    ...
    <body id="dashboard" onload="fetchEdit();">
        <div id="header">
            ...
            <div class="col-md-9 mainbar">
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Edit" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="post topic" name="topic" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="form-label">Post Full Story</label>
                                <div class="form-inline">
                            ...
                            <div class="form-group">
                                        <input type="button" class="btn btn-primary btn-lg" id="update" onclick="edit();" value="update post"/>
                            </div>
                        </form>
                    </div>
