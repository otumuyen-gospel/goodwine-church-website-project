                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="form-label">Enter Privacy Policy</label>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" id="privacy" onclick="privacy();">Update Privacy</button>
                            </div>
                        </div>
                    </div>
