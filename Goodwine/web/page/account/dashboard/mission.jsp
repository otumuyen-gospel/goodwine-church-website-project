            ...
            <div class="col-md-9 mainbar">
                <div id="message-panel">
                    <div class="alert alert-success" role="alert">
                        ...
                        Home / Dashboard / Mission statement
                    </div>
                </div>
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Mission" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">Enter Mission statement</label>
                            ...
                            <div class="form-group">
                                <input type="button" class="btn btn-primary btn-lg" id="updateMission" onclick="mission();" value="Update Statement">
                            </div>
                        </form>
                    </div>
