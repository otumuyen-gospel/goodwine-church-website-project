...
<html  lang="en">
    <head>
        <title>account - testimonials</title>
        <meta charset="utf-8">
            ...
            <div class="col-md-9 mainbar">
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Testimonial" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            <div class="form-group">
                                <label class="form-label">Testimony Heading</label>
                                <input type="text" class="form-control" placeholder="topic" name="topic" />
                            </div>
                            <div class="form-group">
                                <label class="form-label">Testifier</label>
                                <input type="text" class="form-control" placeholder="testifier" name="author"/>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Image Of Testifier</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label class="form-label">Full Testimony</label>
                                <div class="form-inline">
                            ...
                            <div class="form-group">
                                        <input type="button" class="btn btn-primary btn-lg" id="update" onclick="testimonials();" value="save post"/>
                            </div>
                        </form>
                    </div>
