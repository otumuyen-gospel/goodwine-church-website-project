            ...
            <div class="col-md-9 mainbar">
                <div id="message-panel">
                    <div class="alert alert-success" role="alert">
                        ...
                        Home / Dashboard / Church Locations
                    </div>
                </div>
                ...
                <div class="panels">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control input-lg" type="text" name="center">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="form-label">Worship Day 1</label>
                                <div class="form-inline">
                                    <select class="form-control" name="day1">
                                        <option selected>Select Worship Day</option>
                                    ...
                                    <input type="text" class="form-control" placeholder="worship time" name="time1"/>
                                    <input type="text" class="form-control" placeholder="name of services" name="services1"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Worship Day 2</label>
                                <div class="form-inline">
                                    ...
                                    <input type="text" class="form-control" placeholder="worship time" name="time2"/>
                                    <input type="text" class="form-control" placeholder="name of services" name="services2"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Worship Day 3</label>
                                <div class="form-inline">
                                    <select class="form-control" name="day3">
                                        <option selected>Select Worship Day</option>
                                        <option>Monday</option>
                                        <option>Tuesday</option>
                                        <option>Wednesday</option>
                                    ...
                                    <input type="text" class="form-control" placeholder="worship time" name="time3"/>
                                    <input type="text" class="form-control" placeholder="name of services" name="services3"/>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" id="location" onclick="locations();">Save Location</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-offset-1 col-sm-10">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="form-label">Contact Phone number separated with commas</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" id="phone" onclick="phone();">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
