...
<html  lang="en">
    <head>
        <title>account - subscribers</title>
        <meta charset="utf-8">
    ...
    <body id="dashboard" onload="subscriber_table();">
        <div id="header">
            ...
            <div class="col-md-9 mainbar">
                <div id="message-panel">
                    <div class="alert alert-success" role="alert">
                        ...
                        Home / Dashboard / Manage Subscribers
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover" id="table">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4">
                                    <div class="buttons">
                                        <button class="btn btn-danger" onclick="subscriber_table();" id="subscriber">MORE DATA</button>
        ...
        <div class="container-fluid">
            <div id="mymodal">
                <div class="col-sm-offset-3 col-sm-6 message-holder">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="form-label pull-right" id="close">&times;</label>
                        </div>
                        <div class="form-group">
                            <h4 class="text-center" id="title">SEND EMAIL MESSAGE</h4>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Subject</label>
                            <input type="text" class="form-control" placeholder="subject of message" name="subject"/>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Recipient</label>
                            <input type="text" class="form-control" placeholder="Recipient" id="recipient" name="recipient"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button class="btn btn-danger" id="send" onclick="reply();">Send Message</button>
                        </div>
                    </div>
                </div>
            </div>
