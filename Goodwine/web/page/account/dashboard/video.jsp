...
<html  lang="en">
    ...
    <body id="dashboard" onload="fetchVideo();">
        <div id="header">
        ...
        <div id="main">
            ...
            <div class="col-md-9 mainbar">
                ...
                <form class="panels" id="form" action="<%=request.getContextPath()%>/Video" 
                      enctype="multipart/form-data" method="POST" accept="video/mp4">
                    <div class="col-md-offset-1 col-md-10 embed-responsive  embed-responsive-16by9">
                        <video class="embed-responsive-item" src="../../../resource/video.mp4" controls></video>
                    </div>
                    <div class="col-md-offset-1 col-md-10 videoupload">
                        <div class="form-group">
                            <input type="file" class="form-control input-lg" name="video">
                        </div>
                        <div class="form-group">
                            <input type="button" class="btn btn-primary btn-lg" id="update" onclick="uploadVideo();" value="Upload Video">
                        </div>
