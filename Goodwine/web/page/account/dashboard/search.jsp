...
<html  lang="en">
    <head>
        <title>account - search - Good Wine is a living christian bible believing church,
            life transforming and an atmosphere of love."</title>
        <meta charset="utf-8">
    ...
    <body id="dashboard" onload="search();">
        <div id="header">
