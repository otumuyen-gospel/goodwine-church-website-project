                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="form-label">Enter Church History</label>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-lg" id="history" onclick="history();">Update History</button>
                            </div>
                        </div>
                    </div>
