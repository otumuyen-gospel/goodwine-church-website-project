            ...
            <div class="col-md-9 mainbar">
                ...
                <div class="panels">
                    <div class="col-sm-offset-1 col-sm-10">
                        <form class="form-horizontal" id="form" action="<%=request.getContextPath()%>/Event" 
                      enctype="multipart/form-data" method="POST" accept="image/png,image/jpg,image/jpeg,image/gif">
                            ...
                            <div class="form-group">
                                <label class="form-label">Graphic For this event</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label class="form-label">Detail Of Event</label>
                                <div class="form-inline">
                            ...
                            <div class="form-group">
                                    <input type="button" class="btn btn-primary btn-lg" id="update" onclick="events();" value="save post"/>
                            </div>
                        </form>
                    </div>
