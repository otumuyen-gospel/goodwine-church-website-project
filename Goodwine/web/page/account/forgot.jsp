            ...
            <div class="col-sm-12">
                <div class="col-md-push-4 col-md-4" id="login">
                    <div class="form-group">
                        <h2 class="form-text text-center"><span class="glyphicon glyphicon-lock"></span>Forgot Password</h2>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="form-control btn btn-primary input-lg" id="btn-forgot" onclick="forgot();">Proceed</button>
                    </div>
