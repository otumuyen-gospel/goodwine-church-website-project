 ...
 throws ServletException, IOException { 
         ...
         if(!statement.isEmpty()){
             ...
             if(source.exists()){
                 ...
                 if(updateDatabase(resource.webUploadPath()
                      ...
                      response.getWriter().write("vision statement updated successfully");
              ...
              response.getWriter().write("please write a vision statement");
         }
  ...
  public boolean updateDatabase(String realPath,String fileName,String statement){
        ...
        if(jdbc.getRowSize("about") > 0){
            try{
                 ResultSet rs  = jdbc.query("select vision_image from about");
                 if(rs.next()){
            ...
            if(jdbc.update("update about set vision_image='"+fileName+"', vision_message='"+statement+"'")){
                //delete old file
