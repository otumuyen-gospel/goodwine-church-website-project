 ...
 throws ServletException, IOException { 
         ...
         if(!statement.isEmpty()){
             ...
             if(source.exists()){
                 ...
                 if(updateDatabase(resource.webUploadPath()
                      ...
                      response.getWriter().write("values statement updated successfully");
              ...
              response.getWriter().write("please write your values statement");
         }
  ...
  public boolean updateDatabase(String realPath,String fileName,String statement){
        ...
        if(jdbc.getRowSize("about") > 0){
            try{
                 ResultSet rs  = jdbc.query("select values_image from about");
                 if(rs.next()){
            ...
            if(jdbc.update("update about set values_image='"+fileName+"', value='"+statement+"'")){
                //delete old file
